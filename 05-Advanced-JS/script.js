...
interviewQuestion('designer')('Joan');
...
a) question itself
b) the answers from wich the player can choose the correct one (choose an adequate data structure here,
array, object, etc.)
c) correct answer (I would use a number for this)

2. Create a couple of questions using the constructor

3. Store theam all inside an array
...
8. After you display the result, display the next random question, so that the game never ends (Hint:
    write a function for this and all it right after displaying the result).

9. be careful: after Task 8, the game literraly never ends. So include the option to quit the game if the
...
the score (Hint: I'm going to use the power of clsures for this, but you don't have to, just do this 
 ...
 */
 ...
 (function(){
     ...
     var q1 = new Question('Is JavaScript the coolest programming lengage in the world?', ['Yes', 'No'], 0);
