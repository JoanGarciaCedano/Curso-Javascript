...
//         continue;
//     }
//     cur.textContent = 'I changed in ES6';
// }
...
// question.set(false, 'Wrong, prease try again');
...
/**
 * Suppose that you're working in a small town administration, and you're in charge of
 * two elements:
 * 1. Parks
 * 2. Streets
 * 
 * It's a very small town, so right now there are only 3 parks and 4 streets. All parks
 * and streets have a name and build year.
 * 
...
function calc(arr) {
    ...
    const sum = arr.reduce((prev, curr, index) => prev + curr);
...
function reportParks(p){
    ...
    console.log(`Our ${p.length} parks have an averge of ${averageAge} years.`)
